              ...
              <li class="nav-item">
                  ...
                  <div class="collapse" id="posts">
                      <ul class="nav flex-column sub-menu">
                          <li class="nav-item"><a class="nav-link" href="pages/posts/manage-post.html">Manage Post</a></li>
                          <li class="nav-item"><a class="nav-link" href="pages/posts/manage-category.html">Manage Category</a></li>
                      </ul>
                  </div>
              </li>
                                    ...
                                    <div class="col-lg-6">
                                      <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                          ...
                                          <h4 class="mb-0 fw-bold">90000</h4>
                                        </div>
                                      </div>
                                    </div>
                                  </div>
