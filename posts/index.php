    ...
    <div class="container">
        <?php 
            ...
            foreach ($rows as $row) {
                ...
                echo "<img src='thumbnails/" . htmlspecialchars($row['post_thumbnail']) . "' alt='" . htmlspecialchars($row['Title']) . "' class='post-thumbnail'>";
                echo "<div class='post-content'>";
                echo "<h2 class='title'>" . htmlspecialchars($row['Title']) . "</h2>";
                echo "<p class='post-meta'><strong>Description:</strong> " . htmlspecialchars($row['description']) . "</p>";
